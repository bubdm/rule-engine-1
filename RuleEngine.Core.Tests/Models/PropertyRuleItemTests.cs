...
{
    public sealed class PropertyRuleItemTests
    {
        ...
        public void Constructor_WhenNoJoinTypeIsSpecified_ShouldConstructObjectWithNoneJoinType()
        {
            ...
            RuleItem ruleItem = new PropertyRuleItem(leftPredicate, operatorType, rightPredicate);
            ...
            ruleItem.IsRightPredicateConstant.Should().BeFalse();
        }
        ...
        public void Constructor_WhenJoinTypeIsSpecified_ShouldConstructObjectWithJoinType()
        {
            ...
            RuleItem ruleItem = new PropertyRuleItem(leftPredicate, operatorType, rightPredicate, joinType);
